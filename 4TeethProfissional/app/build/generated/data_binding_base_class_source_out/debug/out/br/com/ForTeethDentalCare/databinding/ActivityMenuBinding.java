...
public final class ActivityMenuBinding implements ViewBinding {
  ...
  private ActivityMenuBinding(@NonNull CoordinatorLayout rootView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMenuBinding((CoordinatorLayout) rootView, toolbar);
    }
